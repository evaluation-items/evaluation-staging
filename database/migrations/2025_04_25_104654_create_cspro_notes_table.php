...
return new class extends Migration
{
    ...
    {
        Schema::create('imaster.cspro_notes', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('cspro_answer_id');
            $table->foreign('cspro_answer_id')->references('id')->on('imaster.cspro_answer')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('imaster.cspro_notes');
    }
};

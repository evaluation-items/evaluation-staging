                ...
                <div class="row table-responsive">
                  <table width="100%" class="table table-bordered table-hover table-stripped">
                    ...
                    <tr>
                      ...
                      <td>{{$pval->implementing_office}}</td>
                    </tr>
                    <tr>
                      <th>HOD/ Branch Contact No. (કચેરી ના સંપર્ક નંબર)</th>
                      <td>
                       {{ $pval->implementing_office_contact}}
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <th>Name of Implementing office (અમલીકરણ ઓફિસ નું નામ) </th>
                      <td> {{ $pval->hod_name }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        @if(!empty($pval->major_indicator_hod))
                            {{ $pval->major_indicator_hod }}
                            {!! '<br>' !!}
                        @endif
                      </td>
                    </tr>

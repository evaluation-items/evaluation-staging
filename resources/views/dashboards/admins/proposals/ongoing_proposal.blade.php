              ...
              <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                  ...
                  <div class="d-flex text-center flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Ongoing Proposals</h5>
                    <!--end::Page Title-->                  
                  </div>
                  <!--end::Page Heading-->
                </div>
                  ...
                  <div class="card card-custom gutter-b">
                      <div class="card-header flex-wrap py-3">
                        <div class="card-toolbar">
                          <h5>List of ongoing Evaluation Studies at various stages</h5>
                        </div>
                      </div>
                      <div class="card-body">
                        <div class="row">
                                ...
                                <tbody>
                                  ...
                                  @foreach($ongoing_proposal as $prop)
                                    ...
                                    @if(App\Models\Stage::where('scheme_id',$prop->scheme_id)->latest()->first())
                                      <a href="{{ route('stages.show', ['stage' => $prop->scheme_id]) }}" class="btn btn-xs btn-info" style="display: inline-block">Detailed Stages</a>
                                      @endif
                                    </td>
                                    </tr>
                                    @endforeach

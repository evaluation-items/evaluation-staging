          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">{{ __('message.admin_user') }} {{ __('message.profile') }}</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-3">
              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  ...
                  <p class="text-muted text-center">{{ __('message.admin_user') }}</p>
                      ...
                      <form class="form-horizontal" method="POST" action="{{ route('adminUpdateInfo') }}" id="AdminInfoForm">
                        ...
                        <div class="form-group row">
                          <div class="offset-sm-2 col-sm-10">
                            ...
                            <div id="load_gif_img">
                              <img id="" src="{{asset('loading.gif')}}" style="max-width:200px;max-height:200px">
                            </div>
                          </div>
                        </div>
                      </form>

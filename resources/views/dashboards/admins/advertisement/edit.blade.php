        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <h5 class="text-dark font-weight-bold my-1 mr-5">
             {{ __('message.advertiesment')}} {{ __('message.edit')}}
            </h5>
            <!--end::Page Title-->                  
          </div>
          <!--end::Page Heading-->
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-xxl-12">
                           ...
                           @php
                              // dd($sub_departments);
                           @endphp
                            <form action="{{ route('advertisement.update',[Crypt::encrypt($add->id)]) }}" method="POST" id="frmAdvertiesment">
                                @csrf
                                @method('PUT')
                               
                                <div class="row form-group">
                                    <label for="name">{{ __('message.name')}} <span class="required_filed"> * </span> :</label>
                                    <input type="text" name="name" class="form-control pattern" value="{{$add->name}}" id="name" maxlength="100" autocomplete="off">
                                </div>
                                <div class="row">

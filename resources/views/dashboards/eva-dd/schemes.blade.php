...
@section('title','Schemes - Eval. D.D.')
                     ...
                     <table class="table table-bordered table-hover show-datatable" id="kt_datatable" style="margin-top: 13px !important">
                      ...
                      @foreach($schemes as $scheme)
                        ...
                        <tr>
                          ...
                          <td>{{ $scheme['scheme_overview'] }}</td> 
                          <td>{{ $scheme['scheme_objective'] }}</td> 
                          <td>{{ $scheme['sub_scheme'] }}</td> 
                          <td width="20%">
                            <a href="{{ route('evaldd.scheme_detail',$scheme['scheme_id']) }}" class="btn btn-info">View</a>
                            @if(auth()->user()->role == 15)
                            <a href="{{ route('stages.create', ['scheme_id' => $scheme['scheme_id']]) }}" class="btn btn-info">Add Stage</a>
                            @endif
                          </td> 
                        </tr>
                        @php $i++; @endphp

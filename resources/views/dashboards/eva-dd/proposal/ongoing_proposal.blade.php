                  ...
                  <div class="card card-custom gutter-b">
                      <div class="card-header flex-wrap py-3">
                        <div class="card-toolbar">
                          <h5>{{ __('message.ongoing_evaluation_studies') }}</h5>
                        </div>
                      </div>
                      <div class="card-body">
                        <div class="row">
                        ...
                        <table class="table table-bordered table-striped dataTable dtr-inline" id="example1">
                          <thead>
                            ...
                            <tbody>
                              ...
                              @if(!is_null($prop->schemeSend->team_member_dd)) <!-- For all DD adnd RO-->
                                  @php
...
<script src="{{asset('js/jquery.min.js')}}"></script><script>
  $(document).ready(function(){
    $('.dataTable').DataTable({
          columnDefs: [
              { type: 'date', targets: 2 } // Target the first column (Assigned Date) for date sorting
          ]
      });
  });
</script>
...
@section('title','Schemes - Dept. Sec.')
              ...
              <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                  ...
                  <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Scheme List</h5>
                    <!--end::Page Title-->                  
                  </div>
                  <!--end::Page Heading-->
                </div>
                     ...
                     <table class="table table-bordered table-hover show-datatable" id="kt_datatable" style="margin-top: 13px !important">
                      ...
                      @foreach($schemes as $scheme)
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('deptsec.scheme_detail',$scheme->scheme_id) }}" class="btn btn-info">View</a>
                          </td> 
                        </tr>
                        @php $i++; @endphp
                        @endforeach

              ...
              <div class="card-body p-10">
                <div class="row table-responsive">
                  <table width="100%" class="table table-bordered table-hover table-stripped">
                    ...
                    <tr>
                      <th>Scheme Beneficiary Selection Criterias</th>
                      <td>
                        @if($pval->scheme_beneficiary_selection_criteria)
                          @php $criteria_sel = json_decode($pval->scheme_beneficiary_selection_criteria); @endphp
                          @foreach($criteria_sel as $selkey => $selval)
                            <p>{{ ++$selkey }}) {{ $selval->beneficiary_selection_criteria }}</p>
                          @endforeach
                        @endif
                      </td>
                    </tr>
                  ...
                  <table class="table table-bordered table-hover table-stripped" style="margin-top:-20px;">
                    <tr>
                      ...
                      <th colspan="3" style="text-align: center;">Physical</th>
                      <th colspan="2" style="text-align: center;">Financial</th>
                    </tr>
                    <tr>
                      <th>-</th>
                      <th>Units</th>
                  ...
                  <table width="100%" class="table table-bordered table-hover table-stripped" style="margin-top:-20px">
                    ...
                    <tr>
                      <th>Details about center or state</th>
                      <td>

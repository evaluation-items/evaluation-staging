          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('deptsec.dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active">Department Secretary Profile</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-3">
              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  ...
                  <p class="text-muted text-center">Dept. Sec.</p>
                    ...
                    <div class="active tab-pane" id="personal_info">
                      <form class="form-horizontal" method="POST" action="{{ route('adminUpdateInfo') }}" id="AdminInfoForm">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control pattern" id="inputName2" placeholder="Enter Phone Number" value="{{ Auth::user()->phone }}" name="phone">

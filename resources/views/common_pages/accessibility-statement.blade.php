...
@section('content')
    <div class="menu-item-pages col-lg-9 col-md-8 col-sm-12 left_col">
        ...
        <div class="description" style="margin-top: 1%;">
            <p>The Official website of the Directorate of Economics and Statistics, Gujarat, has been built with an aim to provide maximum accessibility and usability to its visitors.</p>

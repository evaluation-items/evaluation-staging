...
.whatsnew-content{
  height:250px; /* scrolling area height */
  overflow:hidden;
  position:relative;
  background:#fff;
  padding:0 10px;
...
.wn-index{font-weight:700;}
.wn-text span{font-weight:700;font-size:18px;display:block;}
.wn-text img{vertical-align:middle;}
    ...
    margin-top: 38%;">
        ...
        <div class="whatsnew-card" role="region" aria-label="What's new">
            ...
            <div class="read-more-wrap">
                <a class="read-more" href="#" role="button" aria-label="Read more what's new">Read More</a>
            </div>
            </div>
